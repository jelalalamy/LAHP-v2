...
const About = () => {
  return (
    <div className='fixed right-0 bottom-0 w-80 h-64 flex flex-col border-none py-4 justify-top select-none mb-12 mr-2 p-3 bg-black bg-opacity-70 rounded-md'>
