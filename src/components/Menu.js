...
const Menu = () => {
  const items = [
    ...
    { component: <Reminder />, label: 'Set a reminder', icon: 'reminder', height: 'max-h-56', open: false },
    { component: <Timer />, label: 'Start a timer', icon: 'timer', height: 'max-h-56', open: false }
  ]
